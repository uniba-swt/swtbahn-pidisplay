...
sn3218helper = sn3218.SN3218()

# set gamma correction for backlight to normalise brightness
g_channel_gamma = [int(value / 1.6) for value in sn3218helper.default_gamma_table]
r_channel_gamma = [int(value / 1.4) for value in sn3218helper.default_gamma_table]

for x in range(0, 18, 3):
    sn3218helper.channel_gamma(x + 1, g_channel_gamma)
    sn3218helper.channel_gamma(x + 2, r_channel_gamma)
